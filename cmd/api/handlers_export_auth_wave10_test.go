...
func wave10AgingReport() *analytics.AgingReport {
	return &analytics.AgingReport{
...
func wave10BalanceConfirmationSummary() *reports.BalanceConfirmationSummary {
	return &reports.BalanceConfirmationSummary{
...
func wave10BalanceConfirmation() *reports.BalanceConfirmation {
	return &reports.BalanceConfirmation{
		TenantID:     "tenant-1",
		ContactID:    "contact-1",
...
func wave10ContactStatement() *reports.ContactStatement {
	return &reports.ContactStatement{
		TenantID:       "tenant-1",
		ContactID:      "contact-1",
		ContactName:    "Customer",
		Type:           reports.BalanceTypeReceivable,
		...
		ClosingBalance: decimal.NewFromInt(20),
	}
}

func wave10SalesMarginReport() *reports.SalesMarginReport {
	return &reports.SalesMarginReport{
		TenantID:      "tenant-1",
		StartDate:     "2026-01-01",
		EndDate:       "2026-01-31",
		TotalRevenue:  decimal.NewFromInt(100),
...
func wave10CostCenterReport() *accounting.CostCenterReport {
	return &accounting.CostCenterReport{
		TenantID:      "tenant-1",
		PeriodStart:   time.Date(2026, 1, 1, 0, 0, 0, 0, time.UTC),
		PeriodEnd:     time.Date(2026, 1, 31, 0, 0, 0, 0, time.UTC),
		TotalExpenses: decimal.NewFromInt(100),
		TotalBudget:   decimal.NewFromInt(200),
		CostCenters: []accounting.CostCenterSummary{{
			...
			TotalExpenses: decimal.NewFromInt(100),
			BudgetAmount:  decimal.NewFromInt(200),
			BudgetUsed:    decimal.NewFromInt(50),
		}},
	}
}
