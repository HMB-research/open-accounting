...
5. If the conflict is in a Svelte component or frontend test, run the focused component or E2E test that owns the conflicted behavior before broader gates.
