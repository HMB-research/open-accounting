...
type Document struct {
	...
	LifecycleStatus string     `gorm:"column:lifecycle_status;size:20;not null;default:'ACTIVE'" json:"lifecycle_status"`
	LifecycleNote   *string    `gorm:"column:lifecycle_note;type:text" json:"lifecycle_note,omitempty"`
