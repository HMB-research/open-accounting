...
var providerPresetAliases = map[MigrationProviderPreset]map[FileKind]map[string]string{
	...
	MigrationProviderPresetSmartAccounts: {
		...
		KindContacts: {
			...
			"nimi":            "name",
			"registrikood":    "reg_code",
			"kmkr_number":     "vat_number",
			"kmkr number":     "vat_number",
			"aadress":         "address_line1",
			"kontaktandmed":   "email",
		},
		KindInvoices:          mergeAliases(smartAccountsCommercialDocumentAliases("invoice_number", "issue_date"), smartAccountsGridInvoiceAliases()),
		...
		KindPayments: {
			...
			"nr":                    "payment_number",
			"teine_osapool":         "contact_name",
			"teine osapool":         "contact_name",
			"kirjeldus":             "notes",
			"pangakonto":            "bank_account",
			"kassa":                 "payment_account_code",
			"kuupäev":               "payment_date",
			"kuupaev":               "payment_date",
			"summa":                 "amount",
			"€/$":                   "currency",
		...
		KindFixedAssets: {
			...
			"kood":                                "asset_number",
			"kirjeldus":                           "name",
			"soetusmaks":                          "purchase_cost",
			"soetusmaks.":                         "purchase_cost",
			"soetatud":                            "purchase_date",
			"arv_algus":                           "depreciation_start_date",
			"arv. algus":                          "depreciation_start_date",
			"amort_%":                             "depreciation_rate",
			"amort. %":                            "depreciation_rate",
			"arv_lõpp":                            "depreciation_end_date",
			"arv_lopp":                            "depreciation_end_date",
			"arv. lõpp":                           "depreciation_end_date",
			"vastutav_isik":                       "responsible_person",
			"vastutav isik":                       "responsible_person",
		...
		KindJournalEntries: {
			...
			"nr":                  "entry_reference",
			"kp":                  "entry_date",
			"alusdokument":        "source_document",
			"kirjeldus":           "entry_description",
			"summa":               "debit",
			"€/$":                 "currency",
		},
		KindEmployees: {
		...
		KindPayrollHistory: {
			...
			"pay_period_year":              "period_year",
			"pay_period_month":             "period_month",
			"payroll_year":                 "period_year",
			"payroll_month":                "period_month",
			"pay_year":                     "period_year",
			"pay_month":                    "period_month",
			"run_year":                     "period_year",
			"run_month":                    "period_month",
			"payroll_status":               "status",
			"paid_date":                    "payment_date",
			"gross_amount":                 "gross_salary",
			"salary_amount":                "gross_salary",
			"taxable_amount":               "taxable_income",
			"employee_unemployment_amount": "unemployment_insurance_employee",
			"employer_unemployment_amount": "unemployment_insurance_employer",
			"pension_amount":               "funded_pension",
		...
		KindTSDHistory: {
			...
			"basic_exemption_amount":       "basic_exemption",
			"tax_free_amount":              "basic_exemption",
			"employee_unemployment_amount": "unemployment_insurance_employee",
			"employer_unemployment_amount": "unemployment_insurance_employer",
			"pension_amount":               "funded_pension",
			"income_tax_amount":            "income_tax",
...
func meritCommercialDocumentAliases(numberField, dateField string) map[string]string {
	return map[string]string{
		...
		"reg_kood":             "contact_reg_code",
		"reg_nr":               "contact_reg_code",
		"kliendi_registrikood": "contact_reg_code",
		"kliendi_reg_kood":     "contact_reg_code",
		"hankija_registrikood": "contact_reg_code",
		"hankija_reg_kood":     "contact_reg_code",
		"kmkr":                 "contact_vat_number",
		"kmkr_nr":              "contact_vat_number",
		"kliendi_kmkr":         "contact_vat_number",
		"kliendi_kmkr_nr":      "contact_vat_number",
		"hankija_kmkr":         "contact_vat_number",
		"hankija_kmkr_nr":      "contact_vat_number",
		"e_post":               "contact_email",
		"epost":                "contact_email",
		"kliendi_epost":        "contact_email",
		"kliendi_e_post":       "contact_email",
		"hankija_epost":        "contact_email",
		"hankija_e_post":       "contact_email",
...
func smartAccountsCommercialDocumentAliases(numberField, dateField string) map[string]string {
	aliases := map[string]string{
		...
		"contact_reg_no":   "contact_reg_code",
		"contact_registry": "contact_reg_code",
		"customer_reg_no":  "contact_reg_code",
		"supplier_reg_no":  "contact_reg_code",
		"vendor_reg_no":    "contact_reg_code",
		"contact_vat_no":   "contact_vat_number",
...
func smartAccountsGridInvoiceAliases() map[string]string {
	return map[string]string{
		...
		"arve":     "invoice_number",
		"kp":       "issue_date",
		"kanne":    "journal_entry_reference",
		"tähtaeg":  "due_date",
		"tahtaeg":  "due_date",
		"summa":    "total_amount",
		"maksmata": "balance_due",
		"€/$":      "currency",
		"objekt":   "cost_center_code",
	}
}
