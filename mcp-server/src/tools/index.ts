...
export async function handleToolCall(
  ...
  try {
    ...
    switch (name) {
      case 'list_invoices': {
        const { tenant_id, status, type, limit } = args as {
          tenant_id: string;
          status?: string;
          type?: string;
          limit?: number;
      ...
      case 'create_invoice': {
        const { tenant_id, ...invoiceData } = args as {
          tenant_id: string;
          [key: string]: unknown;
        };
      ...
      case 'get_account_balance': {
        const { tenant_id, account_id, as_of_date } = args as {
          tenant_id: string;
          account_id: string;
          as_of_date?: string;
        };
      ...
      case 'generate_report': {
        const { tenant_id, report_type, start_date, end_date } = args as {
          tenant_id: string;
          report_type: string;
          start_date?: string;
          end_date?: string;
      ...
      case 'list_contacts': {
        const { tenant_id, search, type } = args as {
          tenant_id: string;
          search?: string;
          type?: string;
        };
      ...
      case 'record_payment': {
        const { tenant_id, ...paymentData } = args as {
          tenant_id: string;
          [key: string]: unknown;
        };
      ...
      case 'reset_demo_data': {
        const { secret } = args as { secret: string };
