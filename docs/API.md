...
When a payment allocation and its same-bundle imported invoice CSV target both provide the same contact reference field, validation also rejects mismatched contact values before allocation totals are accumulated.
