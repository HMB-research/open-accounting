...
1. Extend remediation actions beyond year-end close, migration preflight, and KMD tax into payroll, document-retention, remaining tax, and accountant-workspace follow-up surfaces.
