...
| Accountant review workspace | `Partial` | Tenant review queue, cross-tenant portfolio rollup, overdue invoice actions, bank follow-up states, journal evidence follow-up, document-review links, and close, migration preflight, KMD, TSD declaration, payroll run, and document remediation data available through API/CLI for workspace integration. | Frontend/backend tests, smoke E2E, seeded demo E2E, focused close/migration/KMD/TSD/payroll/document remediation tests, and status docs. | Deeper workspace actions across tax, payroll, documents, migration follow-up assignment, and close remediation assignment remain missing. |
...
1. Extend remediation actions beyond year-end close, migration preflight, KMD tax, TSD declarations, payroll runs, and document evidence/retention into remaining tax/payroll edges and accountant-workspace follow-up surfaces.
