...
4. Add deeper executable accountant workspace exception actions beyond confirmation-ready migration saved-run execution, document-retention date setting, evidence upload/replacement, and TSD acceptance marking, plus remaining non-KMD tax/payroll/document edges.
