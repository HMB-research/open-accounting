...
1. Extend remediation actions beyond year-end close, migration preflight, KMD tax, TSD declarations including direct XML export and acceptance marking, payroll runs, banking transactions, expense claims, and document evidence/retention into remaining non-KMD tax/payroll edges and accountant-workspace follow-up surfaces.
...
4. Add deeper executable accountant workspace exception actions beyond confirmation-ready migration saved-run execution, document-retention date setting, evidence upload/replacement, unapproved-evidence approval, and TSD acceptance marking, plus remaining non-KMD tax/payroll/document edges.
