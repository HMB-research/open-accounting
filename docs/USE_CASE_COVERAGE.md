...
| Settings, admin, backup, and restore operations | `Partial` | SMTP settings, templates, production startup checks, backup creation, offsite sync wrapper, backup health check, and restore-drill wrapper. | Backend tests, CLI coverage gates, deployment docs, and status docs. | Provider credential scheduling, recurring restore drills, metrics, structured errors, and runbooks need hardening. |
...
5. Harden backup credential scheduling, recurring restore drills, metrics, structured errors, and runbooks.
