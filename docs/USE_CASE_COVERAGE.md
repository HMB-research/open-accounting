...
- PR #62 on `feat/payroll-history-import` was green at commit `9888937` in CI run `27475433666`.
...
4. Add deeper executable accountant workspace exception actions for migration execution, remaining tax/payroll/document edges, and direct in-workspace completion controls.
