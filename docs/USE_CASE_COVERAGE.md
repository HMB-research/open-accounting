...
- PR #62 on `feat/payroll-history-import` was green at commit `77f057c` in CI run `27470695729`.
...
1. Extend remediation actions beyond year-end close, migration preflight, KMD tax, TSD declarations, payroll runs, banking transactions, and document evidence/retention into remaining tax/payroll edges and accountant-workspace follow-up surfaces.
