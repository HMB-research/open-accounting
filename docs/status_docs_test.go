...
func TestUseCaseCoverageMatrixDocumentsGoalEvidence(t *testing.T) {
	...
	for _, snippet := range []string{
		...
		"Broader vendor mapping presets, deeper cross-file validation, and live streaming telemetry remain open.",
