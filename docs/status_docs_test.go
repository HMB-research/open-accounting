...
func TestStatusDocumentationTracksCurrentGates(t *testing.T) {
	...
	required := map[string][]string{
		...
		"docs/DEVELOPMENT_STATUS.md": {
			...
			"TSD/KMD declaration tax-support attachments, and TSD submission evidence enforcement",
...
func TestUseCaseCoverageMatrixDocumentsGoalEvidence(t *testing.T) {
	...
	for _, snippet := range []string{
		...
		"workflow blockers for reconciliation, assets, purchase invoices, journal entries, payments, expenses, leave records, TSD declarations, KMD declarations, close packs, and TSD submission",
		"focused document entity and TSD submission evidence tests",
