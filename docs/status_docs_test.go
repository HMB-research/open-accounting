...
func TestUseCaseCoverageMatrixDocumentsGoalEvidence(t *testing.T) {
	...
	for _, snippet := range []string{
		...
		"Broader vendor mapping presets, deeper cross-file validation, and dashboard-side live stream wiring remain open.",
