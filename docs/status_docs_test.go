...
func TestStatusDocumentationTracksCurrentGates(t *testing.T) {
	...
	required := map[string][]string{
		...
		"DEVELOPMENT_STATUS.md": {
			...
			"latest verified CI baseline reviewed on 2026-08-05",
			"Backend coverage: 100.0% statements (`46630/46630`, zero missed statements)",
			"Frontend coverage: 99.9% statements, 100% functions, 99.9% lines, and 96.97% branches across 686 tests in 35 files",
			"Frontend E2E inventory: 65 seeded-demo spec files plus 1 blocking smoke spec",
			"CI run 31005894159",
			"coverage run 31005894127",
		...
		"CURRENT_PRODUCT_LIMITS.md": {
			...
			"☐ Needs work for full product parity",
			"🚫 **Blocked**",
		...
		"USE_CASE_COVERAGE.md": {
			"Last reviewed: 2026-08-05",
			"Latest verified CI baseline reviewed on 2026-08-05",
			"backend coverage is 100.0% statements (`46630/46630`, zero missed statements)",
			"frontend coverage is 99.9% statements, 100% functions, 99.9% lines, and 96.97% branches across 686 frontend tests in 35 files",
			"CI run 31005894159",
			"coverage run 31005894127",
