...
func TestStatusDocumentationTracksCurrentGates(t *testing.T) {
	...
	required := map[string][]string{
		"README.md": {
			...
			"bank-transaction source-account default-currency consistency stage",
		...
		"docs/DEVELOPMENT_STATUS.md": {
			...
			"focused bank-transaction source-account default-currency consistency migration coverage",
...
func TestUseCaseCoverageMatrixDocumentsGoalEvidence(t *testing.T) {
	...
	for _, snippet := range []string{
		...
		"focused bank-transaction source-account default-currency consistency migration tests",
		"payment allocation invoice-status consistency stage",
