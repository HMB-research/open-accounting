...
func TestStatusDocumentationTracksCurrentGates(t *testing.T) {
	...
	required := map[string][]string{
		"README.md": {
			...
			"Broader plugin production hardening beyond the current loopback HTTP runtime, supervised package runtime startup/proxy/shutdown/status/manual restart/automatic crash restart, and safe operator-bundled frontend component registry",
		},
		"docs/DEVELOPMENT_STATUS.md": {
			...
			"Journal-entry and payment-receipt evidence conflicts now return document evidence-policy results",
