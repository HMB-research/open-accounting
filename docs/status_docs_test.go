...
func TestUseCaseCoverageMatrixDocumentsGoalEvidence(t *testing.T) {
	...
	for _, snippet := range []string{
		...
		"Additional provider-specific mapping presets, deeper cross-file validation, and dashboard-side mutating cutover controls remain open.",
