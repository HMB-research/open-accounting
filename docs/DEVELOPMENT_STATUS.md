...
| Report exports | `Beta` | Trial balance, account balance, balance sheet, income statement, cash flow, aging, balance confirmation, and cost-center budget reports now have backend CSV, XLSX, and PDF export through API and CLI. Some specialized report exports are still incomplete. |
