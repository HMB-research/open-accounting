...
- Historical payroll run/payslip import, leave-balance import, KMD history import, product master/stock import, and fixed-asset import are now available through API and CLI, but broader incumbent-system cutover is still incomplete.
...
1. Extend historical migration beyond payroll, tax history, product/stock, and fixed assets into broader incumbent-system cutover imports.
