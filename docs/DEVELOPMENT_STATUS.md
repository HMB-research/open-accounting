...
| Report exports | `Working` | Trial balance, account balance, balance sheet, income statement, cash flow, aging, balance confirmation, customer/vendor contact statements, and cost-center budget reports have backend CSV, XLSX, and PDF export through API and CLI, with shared invalid-format handling. |
