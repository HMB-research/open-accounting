...
| Report exports | `Beta` | Trial balance, balance sheet, income statement, and cash flow now have backend CSV and XLSX export through API and CLI. Extended report export coverage is still incomplete. |
