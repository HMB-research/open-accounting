...
| Payroll, leave management, TSD generation/export | `Working` | Payroll run calculation/approval, bulk payroll run processing, leave balances/records, and TSD XML/CSV export exist; automatic submission does not. |
