...
| Inventory and warehouse flows | `Beta` | Product/category/warehouse CRUD, CSV imports, signed stock adjustments, stock import, per-warehouse stock levels, and warehouse transfers exist through API and CLI. Reservation, fulfillment allocation, and deeper inventory costing workflows remain thin. |
