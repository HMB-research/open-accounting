...
| KMD generation/export, INF reporting, and historical import | `Working` | KMD generation/export, KMD INF A/B invoice reporting, and row-level historical KMD CSV import exist; direct e-MTA submission does not. |
