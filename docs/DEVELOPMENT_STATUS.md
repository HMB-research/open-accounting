...
| Report exports | `Beta` | Trial balance, balance sheet, income statement, cash flow, aging, and balance confirmation reports now have backend CSV and XLSX export through API and CLI. PDF and some specialized report exports are still incomplete. |
