...
| Banking CSV import and reconciliation | `Working` | Manual import and reconciliation work, SEPA pain.001 XML payment-file export is available for manual bank upload, and reconciliation completion now blocks transactions explicitly marked `EVIDENCE_REQUIRED` until approved reconciliation evidence is attached. Direct bank feeds and direct bank submission do not. |
