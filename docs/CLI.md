...
go run ./cmd/oa inventory issue --product-id <product-id> --warehouse-id <warehouse-id> --quantity 2 --lot-number LOT-2026-01 --expiry-date 2027-01-31 --reference INV-001 --source-type SALES_INVOICE --source-id <invoice-id> --cogs-account-id <expense-account-id>
