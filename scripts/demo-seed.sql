...
-- =============================================================================
-- LEAVE MANAGEMENT (Puhkuste haldus)
-- =============================================================================

-- Absence Types (tenant-specific copy from system defaults)
INSERT INTO tenant_acme.absence_types (id, tenant_id, code, name, name_et, is_paid, affects_salary, requires_document, document_type, default_days_per_year, max_carryover_days, tsd_code, is_system, sort_order) VALUES
('9D000000-0000-0000-0001-000000000001'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, 'ANNUAL_LEAVE', 'Annual Leave', 'Põhipuhkus', true, false, false, NULL, 28, 28, NULL, true, 1),
('9D000000-0000-0000-0001-000000000002'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, 'SICK_LEAVE', 'Sick Leave', 'Haigusleht', true, true, true, 'TK66', 0, 0, '10', true, 2),
('9D000000-0000-0000-0001-000000000003'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, 'CHILD_SICK', 'Child Sick Leave', 'Lapse hooldusleht', true, true, true, 'TK66', 0, 0, '11', true, 3),
('9D000000-0000-0000-0001-000000000004'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, 'STUDY_LEAVE', 'Study Leave', 'Õppepuhkus', true, false, true, 'School certificate', 30, 0, NULL, true, 6),
('9D000000-0000-0000-0001-000000000005'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, 'UNPAID', 'Unpaid Leave', 'Palgata puhkus', false, true, false, NULL, 0, 0, NULL, true, 7)
ON CONFLICT DO NOTHING;

-- Leave Balances for 2024 and 2025
INSERT INTO tenant_acme.leave_balances (id, tenant_id, employee_id, absence_type_id, year, entitled_days, carryover_days, used_days, pending_days) VALUES
-- Maria Tamm - 2024 (started Jan 2023, full entitlement)
('9E000000-0000-0000-0001-000000000001'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000001'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2024, 28, 0, 14, 0),
('9E000000-0000-0000-0001-000000000002'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000001'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2025, 28, 14, 0, 5),
-- Jaan Kask - 2024
('9E000000-0000-0000-0001-000000000003'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000002'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2024, 28, 3, 21, 0),
('9E000000-0000-0000-0001-000000000004'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000002'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2025, 28, 10, 0, 0),
-- Anna Mets - 2024 (started March, prorated)
('9E000000-0000-0000-0001-000000000005'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000003'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2024, 21, 0, 7, 0),
('9E000000-0000-0000-0001-000000000006'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000003'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2025, 28, 14, 0, 0),
-- Peeter Saar - 2024 (senior employee)
('9E000000-0000-0000-0001-000000000007'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000004'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2024, 28, 5, 28, 0),
('9E000000-0000-0000-0001-000000000008'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000004'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, 2025, 28, 5, 0, 10)
ON CONFLICT DO NOTHING;

-- Leave Records (actual absences)
INSERT INTO tenant_acme.leave_records (id, tenant_id, employee_id, absence_type_id, start_date, end_date, total_days, working_days, status, document_number, requested_at, approved_at, approved_by) VALUES
-- Maria Tamm - Summer vacation 2024
('9F000000-0000-0000-0001-000000000001'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000001'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, '2024-07-01', '2024-07-14', 14, 10, 'APPROVED', NULL, '2024-06-01', '2024-06-05', '70000000-0000-0000-0001-000000000002'::uuid),
-- Maria Tamm - Pending January 2025 vacation
('9F000000-0000-0000-0001-000000000002'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000001'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, '2025-01-20', '2025-01-24', 5, 5, 'PENDING', NULL, '2024-12-15', NULL, NULL),
-- Jaan Kask - Summer vacation 2024
('9F000000-0000-0000-0001-000000000003'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000002'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, '2024-08-05', '2024-08-23', 19, 15, 'APPROVED', NULL, '2024-07-01', '2024-07-03', 'a0000000-0000-0000-0000-000000000001'::uuid),
-- Jaan Kask - Sick leave
('9F000000-0000-0000-0001-000000000004'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000002'::uuid, '9D000000-0000-0000-0001-000000000002'::uuid, '2024-11-11', '2024-11-15', 5, 5, 'APPROVED', 'TK66-2024-001', '2024-11-11', '2024-11-11', 'a0000000-0000-0000-0000-000000000001'::uuid),
-- Anna Mets - Vacation
('9F000000-0000-0000-0001-000000000005'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000003'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, '2024-12-23', '2024-12-31', 9, 5, 'APPROVED', NULL, '2024-11-15', '2024-11-20', '70000000-0000-0000-0001-000000000002'::uuid),
-- Peeter Saar - Full vacation usage
('9F000000-0000-0000-0001-000000000006'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000004'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, '2024-06-17', '2024-07-12', 26, 20, 'APPROVED', NULL, '2024-05-15', '2024-05-20', '70000000-0000-0000-0001-000000000002'::uuid),
-- Peeter Saar - Pending vacation 2025
('9F000000-0000-0000-0001-000000000007'::uuid, 'b0000000-0000-0000-0000-000000000001'::uuid, '70000000-0000-0000-0001-000000000004'::uuid, '9D000000-0000-0000-0001-000000000001'::uuid, '2025-02-03', '2025-02-14', 12, 10, 'PENDING', NULL, '2024-12-20', NULL, NULL)
ON CONFLICT DO NOTHING;
