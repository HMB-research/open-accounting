...
- [x] Dashboard migration workbench for cutover bundle assembly, validation, execution planning, saved dry runs, confirmed execution, saved-run monitoring, progress/active-step telemetry, and resume-by-ID selection
...
- [ ] Remaining mutating migration cutover orchestration beyond the guarded CLI/server-side execution, resume-snapshot, saved-run list/get paths, dashboard workbench, and saved-run progress telemetry, especially accountant-workspace launch handoff, step-duration/streaming telemetry, and vendor-specific cutover presets
