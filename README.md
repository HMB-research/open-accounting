...
- [ ] Remaining mutating migration cutover orchestration beyond the guarded CLI/server-side execution and resume-snapshot paths, especially durable dashboard execution and richer vendor-specific cutover presets
