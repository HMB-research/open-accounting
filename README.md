...
- [ ] Remaining mutating migration cutover orchestration beyond the guarded CLI/server-side execution, resume-snapshot, and saved-run list/get paths, especially richer dashboard launch/monitor controls and vendor-specific cutover presets
