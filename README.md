...
> Production hardening, deeper historical cutover tooling beyond payroll, tax, product-category/warehouse/product/stock, and fixed-asset imports, deeper accountant exception actions, and automated document retention/reconciliation policy enforcement are still in progress.
...
- [x] CSV import for chart of accounts, contacts, employees, invoices, product categories/warehouses/products/stock, fixed assets, and opening balances
...
- [ ] Remaining external migration imports beyond payroll, tax history, product-category/warehouse/product/stock, and fixed assets
