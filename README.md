...
| **Migration Preflight**        | Non-mutating CSV/XML bundle validation for required columns, duplicate identifiers, account, contact, employee, payroll-history, commercial-document, inventory, fixed-asset, cost-center/allocation, expense, payment, bank-account, and bank-transaction row values, grouped document consistency, provider-style employee/payroll/leave/TSD aliases, and cross-file references before cutover imports, including e-invoice XML, expenses, commercial history, inventory, banking, tax, cost allocations, and fixed assets |
...
- [x] Migration bundle validation for cutover imports with API and CLI coverage across e-invoice XML, expenses, commercial history, inventory, banking, payroll/TSD tax history, cost allocations, and fixed assets, including duplicate identifiers, account, contact, employee, payroll-history, commercial-document, inventory, fixed-asset, cost-center/allocation, expense, payment, bank-account, and bank-transaction row values, and grouped document consistency
