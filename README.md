...
- [ ] Remaining tax/payroll edges and executable accountant-workspace follow-up beyond current assignment metadata for payroll run, TSD declaration, KMD, close, migration preflight, inventory, banking, expenses, journal, document evidence/retention, and evidence follow-up
