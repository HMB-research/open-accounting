...
- [x] Dashboard migration workbench for cutover bundle assembly, validation, execution planning, saved dry runs, confirmed execution, saved-run monitoring, progress/active-step/duration telemetry, resume-by-ID selection, and accountant-workspace assignment handoff into deep-linked saved runs
...
- [ ] Remaining mutating migration cutover orchestration beyond the guarded CLI/server-side execution, resume-snapshot, saved-run list/get paths, dashboard workbench, saved-run progress/duration telemetry, and accountant-workspace launch handoff, especially live streaming telemetry and vendor-specific cutover presets
