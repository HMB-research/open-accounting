...
- [x] Dashboard migration workbench for cutover bundle assembly, validation, execution planning, saved dry runs, confirmed execution, saved-run monitoring, and resume-by-ID selection
...
- [ ] Remaining mutating migration cutover orchestration beyond the guarded CLI/server-side execution, resume-snapshot, saved-run list/get paths, and dashboard workbench, especially richer progress telemetry, accountant-workspace launch handoff, and vendor-specific cutover presets
