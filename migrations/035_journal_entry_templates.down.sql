DROP FUNCTION IF EXISTS add_journal_entry_templates(TEXT);
...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP TABLE IF EXISTS %I.journal_entry_template_lines', tenant_schema);
        EXECUTE format('DROP TABLE IF EXISTS %I.journal_entry_templates', tenant_schema);
    END LOOP;
END $$;
