-- Rollback migration 056: remove tenant-scoped migration execution run snapshots.
...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP TABLE IF EXISTS %I.migration_execution_runs CASCADE', tenant_schema);
    END LOOP;
END $$;

DROP FUNCTION IF EXISTS add_migration_execution_run_tables(TEXT);
