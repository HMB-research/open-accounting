-- Rollback migration 055: remove inventory lot reservation tracking.
...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP TABLE IF EXISTS %I.inventory_lot_reservations CASCADE', tenant_schema);
    END LOOP;
END $$;

DROP FUNCTION IF EXISTS add_inventory_lot_reservations(TEXT);
