-- Restore the migration-068 tenant bootstrap before removing the helper that
-- migration 069 appended to it.
...
DROP INDEX IF EXISTS public.idx_import_delivery_nonces_expiry;
