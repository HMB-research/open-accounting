-- Migration 031: Allow year-end close-pack evidence documents

CREATE OR REPLACE FUNCTION add_close_pack_document_entity(schema_name TEXT) RETURNS VOID AS $$
BEGIN
...
BEGIN
    ...
    LOOP
        PERFORM add_close_pack_document_entity(tenant_schema);
    END LOOP;
END $$;
